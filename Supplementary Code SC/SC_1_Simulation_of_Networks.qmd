...
axis(side = 1, labels = c(1:6, Inf), at = 1:7, family = "serif")
...
plot(ad_mantel_corlog_geodist, ylim = c(.7, 1), ylab = "Effect size similarity",
                                     xlab = "Geodesic distance", main = "",
     xlim = c(1, 7), las = 1, xaxt = "n", family = "serif")
...
#combined plot:
par(mar = c(4,4,1,1), family = "serif", cex = 2)
...
axis.break(1, breakpos = 6.5)
par(lwd = 1)
axis(side = 1, labels = c(.29, .26, .23, .19, .16, .13, 0), at = 1:7, family = "serif")
text(c(1.11,2,3,4,5,6,6.8), .7,
...
axis(side = 1, labels = c(1-c(.29, .26, .23, .19, .16, .13, 0)), at = 1:7, family = "serif")
text(c(1.11,2,3,4,5,6,6.8), .7,
     labels = c("n = 279", "n = 425", "n = 323", "n = 178", "n = 49", "n = 5", "n = 78.541"), cex = .79)
legend("topleft", legend = c("raw ES", "adjusted ES"), bty = "n", lty = c(1, 2), pch = c(16, 18), col = c("black", "gray50"), lwd = 2, cex = 1.4)
```
...
#| fig-width: 16
#| fig-height: 12
par(mar = c(6,0,0,0), xpd = T, family = "serif")
...
par(mfrow = c(3,4), mar = c(0,0,0,0), xpd = T, family = "serif", oma = c(8,8,0,8), las = 1)
### plot 1 ###
plot.new()
...
par(mar = c(4,4.5,1,1), family = "serif")
